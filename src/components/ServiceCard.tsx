...
import { HealthState, ServiceItem, QBittorrentStatus } from "../types"; // Import QBittorrentStatus
...
interface ServiceCardProps {
  ...
  health: HealthState;
  onRecheck: () => void;
  qbittorrentStatus?: QBittorrentStatus; // New prop for qBittorrent status
}
